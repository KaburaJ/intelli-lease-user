          ...
          <View style={styles.bodyAlignment}>
            ...
            <View style={[styles.midContainer]}>
              <View style={[styles.details]}>
                ...
                />
                <View style={[styles.detail]}>
                  <Text onPress={() => navigation.push("Emergency Contacts")} style={[styles.tags, { marginLeft: -30 }]}>
                    Emergency Contacts
                  </Text>
                  <Text style={[styles.tag, { marginLeft: -30 }]}>
            ...
            <View style={[styles.midContainer]}>
              <View style={[styles.details]}>
                ...
                />
                <View style={[styles.detail]}>
                  <Text                     onPress= {() => navigation.push("My Alarms")} 
 style={[styles.tags, { marginLeft: -20 }]}>
                    My Alarms
                  </Text>
                  <Text style={[styles.tag, { marginLeft: -20 }]}>
                    For My Alarms Viewing Mode
                  </Text>
                </View>
                <Ionicons
                  name="chevron-back-outline"
