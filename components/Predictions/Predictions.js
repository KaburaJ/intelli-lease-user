...
import { ScrollView, StyleSheet, Text, View, TextInput, SafeAreaView, Dimensions } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.innerContainer}>
          ...
          <Text style={styles.text}>Sample of our Predictions</Text>
          <Text style={styles.subTextSmall}>
          Visual of Available data
        </Text>
        <PieChart
          data={pieData}
